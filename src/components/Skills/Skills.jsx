...
import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaGitAlt, FaNode, FaDocker ,FaPhp  } from 'react-icons/fa6'
...
const frontendSkills = [
  ...
  { name: "Next.js", icon: <RiNextjsFill style={{ color: '#000000' }} />, level: 20 },
  { name: "TailwindCSS", icon: <BiLogoTailwindCss style={{ color: '#06B6D4' }} />, level: 85 }
];
