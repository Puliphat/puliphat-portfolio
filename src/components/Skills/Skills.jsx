...
const frontendSkills = [
  ...
  { name: "React.js", icon: <FaReact style={{ color: '#61DAFB' }} />, level: 95 },
  { name: "Next.js", icon: <RiNextjsFill style={{ color: '#000000' }} />, level: 85 },
...
const backendSkills = [
  ...
  { name: "PHP", icon: <FaPhp style={{ color: '#777BB4' }} />, level: 55 },
  { name: "Next.js", icon: <RiNextjsFill style={{ color: '#000000' }} />, level: 85 },
